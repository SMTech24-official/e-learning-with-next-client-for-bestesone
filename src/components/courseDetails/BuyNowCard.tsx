...
const BuyNowCard = () => {
  return (
    <div
      className="py-9 px-8 rounded-[20px]"
      style={{
        boxShadow:
          "0px 4px 16px 0px rgba(16, 24, 40, 0.08), 0px 4px 6px -5px rgba(16, 24, 40, 0.03)",
      }}
    >
      <h2 className="text-4xl font-semibold mb-3 whitespace-nowrap">
        $ 850.00 USD
      </h2>
      <p className="text-sm font-normal text-[#384250] mb-8">
        Provide most popular courses that your want to join and lets start the
        course for the most simply way in here
      </p>
      <Button className=" w-full py-3 rounded-lg bg-primary text-white text-base font-normal leading-6 mb-14">
        Buy Now
      </Button>
