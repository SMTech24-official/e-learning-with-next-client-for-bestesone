      ...
      <div className="container">
        <div className="flex md:flex-row flex-col justify-between gap-[36px] md:items-center">
          <div className="flex flex-col lg:w-2/4">
            ...
            The &quot;Complete Data Science Bootcamp 2024&quot; teaches you essential data science skills, including Python, machine learning, and data analysis, through hands-on projects and real-world applications.
            </p>
            <div className="flex flex-col md:flex-row gap-4 ">
              <Button className="font-semibold" variant={"outline"}><span className="flex justify-center items-center gap-2 w-max"> Near by Courses <ImTarget /></span></Button>
